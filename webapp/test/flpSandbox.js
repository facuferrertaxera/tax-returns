		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "taxreturns",
									"targetURL": "#techtaxerataxreturnsapptaxreturns-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"techtaxerataxreturnsapptaxreturns-display": {
								"semanticObject": "techtaxerataxreturnsapptaxreturns",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tech.taxera.vatreturns.app.vatreturns",
									"url": sap.ui.require.toUrl("tech/taxera/vatreturns/app/vatreturns")
								}
							}
						}
					}
